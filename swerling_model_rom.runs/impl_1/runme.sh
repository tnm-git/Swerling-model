...
HD_PWD='C:/Xilinx/Projects/swerling_model_rom/swerling_model_rom.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log swerling_model_rom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source swerling_model_rom.tcl -notrace
