...
HD_PWD='C:/Xilinx/Projects/swerling_model_rom/swerling_model_rom.runs/log_fun_65536x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log log_fun_65536x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source log_fun_65536x16.tcl
