...
HD_PWD='C:/Xilinx/Projects/swerling_model_rom/swerling_model_rom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swerling_model_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swerling_model_rom.tcl
